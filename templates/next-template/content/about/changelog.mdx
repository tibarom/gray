...
[See more examples](/about/components/breadcrumb)
...
[Read the docs](/about/components/input-otp)
...
However we provide a JavaScript version of the components, available via the [cli](/about/cli).

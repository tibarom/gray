...
**CSS variables must be defined without color space function**. See the [Tailwind CSS documentation](https://tailwindcss.com/about/customizing-colors#using-css-variables) for more information.
...
See the [Tailwind CSS documentation](https://tailwindcss.com/about/customizing-colors#using-css-variables) for more information on using `rgb`, `rgba` or `hsl` colors.

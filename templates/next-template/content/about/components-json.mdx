...
See the <Link href="/about/cli">CLI section</Link> for more information.
...
See the <Link href="/about/installation">installation section</Link> for how to set up Tailwind CSS.
...
For more information, see the <Link href="/about/theming">theming docs</Link>.
